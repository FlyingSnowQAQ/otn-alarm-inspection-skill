...
description: 烽火通信OTN
  WDM设备历史告警可视化巡检工具。当用户需要导入/分析/可视化OTN网络告警数据、查看拓扑图、生成告警报表、进行根因分析时使用此技能。适用于网络运维人员对移动一干400G等OTN网络的日常巡检、故障定位和报告生成。
agent_created: true
disable: true
---
...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| v1.1.3 | 2026-07-17 | 本周无功能变更 — 同步确认（源码打包237K，6/6文件推送） |
